...
# db.execute(my_cmd)
# my_cmd = '''
# CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username TEXT NOT NULL, hash TEXT NOT NULL, cash NUMERIC NOT NULL DEFAULT 1000000000.00);
# '''
# db.execute(my_cmd)
# my_cmd = '''
...
def sell():
    ...
    if request.method == "POST":
        ...
        try :
            ...
            # if user_portfolio[3] < int(shares_nbr):
                return apology("TOO MANY SHARES", 400)
        except :
            return apology("NO PORTFOLIO YET", 400)
